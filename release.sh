...
mvn versions:set -DgroupId=com.github.surnamedd -DartifactId=${projectName} -DoldVersion=${snapshot_version} -DnewVersion=${release_version}
...
mvn versions:set -DgroupId=com.github.surnamedd -DartifactId=${projectName} -DoldVersion=${release_version} -DnewVersion=${snapshot_new_version}
mvn -N versions:update-child-modules
mvn versions:commit
